...
class BienSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Bien::create([
            'bien_codigo'=>Bien::generarCodigo('000001',['descripcion'=>'ANAQUEL MOVIL']),
            'bien_nombre'=>"Estanteria Negro Chida",
            'bien_categoria'=>'ANAQUEL MOVIL',
            'bien_ubicacion_actual'=>'Sistemas Computacionales',
            'bien_estado'=>'activo',
            'bien_modelo'=>'chido',
            'bien_marca'=>'chida',
            'bien_fecha_adquision'=>Carbon::now()->subYear(),
            'bien_valor_monetario' => 300.00,
            'bien_id_dep' => 2
